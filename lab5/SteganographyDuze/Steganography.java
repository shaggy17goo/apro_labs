...
public class Steganography {
    public static void main(String[] arguments) {
        ...
        String inputPath = "/home/mion/s/241/mwawrzyn/IdeaProjects/Kodowanie2/first.bmp";
        String secretImagePath = "/home/mion/s/241/mwawrzyn/IdeaProjects/Kodowanie2/second2.bmp";
    ...
    private void addHiddenBetterImage(byte[] image, byte[] addition) {
        ...
        for(int i=54; i<image.length; i++){
            ...
            byteValue=addition[i];
                bitValue=(byteValue>>>4)&0x04;

                image[k]=(byte)(image[k]>>>4);
                image[k]=(byte)(image[k]<<4);
